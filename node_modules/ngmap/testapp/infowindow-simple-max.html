...
<body>
	<div>
		Info Windows<br /> This example displays a marker at the center of
		Australia. When the user clicks the marker, an info window opens.
		<ng-map default-style="true" center="-25.363882,131.044922" zoom="4">
		<marker id="foo" position="-25.363882,131.044922"
			on-click="map.showInfoWindow(event, 'bar')"> </marker> <info-window
			id="bar" max-width="200">
		<div ng-non-bindable>
			...
			<div id="bodyContent">
				<p>
					...
					to the Pitjantjatjara and Yankunytjatjara, the Aboriginal people of
					the area. It has many springs, waterholes, rock caves and ancient
					paintings. Uluru is listed as a World Heritage Site.
				</p>
				<p>
					Attribution: Uluru, <a
						href="http://en.wikipedia.org/w/index.php?title=Uluru&oldid=297882194">
						http://en.wikipedia.org/w/index.php?title=Uluru </a> (last visited
					June 22, 2009).
				</p>
			</div>
		</div>
