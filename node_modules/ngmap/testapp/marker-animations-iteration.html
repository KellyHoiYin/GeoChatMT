...
<body>
	...
	<br /> If you're adding a number of markers, you may want to drop them
	on the map consecutively rather than all at once. This example shows
	how to use setTimeout() to space your markers' animation.
	<style>
div[ng-controller] {
	position: relative;
}
...
#panel {
	...
	<div ng-controller="MarkerAnimationCtrl as vm">
		...
		<ng-map center="52.520816, 13.410186" zoom="12"> </ng-map>
	</div>
</body>
</html>
