...
<body ng-controller="BasicCtrl1 as vm">
	...
	<div ng-non-bindable>
		Chicago, IL<br /> LatLng: {{vm.chicago.lat()}}, {{vm.chicago.lng()}},
		<br /> World Coordinate: {{vm.worldCoordinate.x}},
		{{vm.worldCoordinate.y}}, <br /> Pixel Coordinate:
		{{vm.pixelCoordinate.x}}, {{vm.pixelCoordinate.y}}, <br /> Tile
		Coordinate: {{vm.tileCoordinate.x}}, {{vm.tileCoordinate.y}} at Zoom
		Level {{vm.map.getZoom()}}
	</div>
	</info-window> </ng-map>
</body>
</html>
