...
<link href="lib/prettify-tomorrow-night.css" type="text/css"
	rel="stylesheet" />
...
<body>
	...
	<div class="left">
		...
		<ul>
			<li
				ng-repeat="example in vm.allExamples | filter:search | filter:'!all-examples' ">
	...
	<div class="right">
		...
		<iframe ng-hide="vm.viewSource" src="map-simple.html" name="iframe"
			frameborder="0"> </iframe>
		<pre ng-show="vm.viewSource" class="source prettyprint lang-html">{{vm.iframeSource}}</pre>
	</div>
	</all-examples>
</body>
</html>
