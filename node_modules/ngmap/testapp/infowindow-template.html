...
<body ng-controller="MyCtrl as vm">
	...
	<script id="custom-cached-info-window-template.html"
	...
	<ng-map default-style="true" center="41,-87" zoom="3"> <info-window
		id="cached" template="{{vm.template.cached}}"></info-window> <info-window
		id="external" template="{{vm.template.external}}"></info-window> <marker
		ng-repeat="(id, store) in vm.stores" id="{{id}}"
