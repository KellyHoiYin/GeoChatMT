...
<body ng-controller="EventSimpleController as vm">
	Simple Click Event
	<br /> Click the marker to zoom and drag and watch it comes back after
	3 seconds.
	<ng-map zoom="4" center="-25.363882, 131.044922"
		on-center-changed="vm.centerChanged()"> <marker
		position="-25.363882, 131.044922" on-click="vm.click()"
		title="Click to zoom"></marker> </ng-map>
</body>
</html>
