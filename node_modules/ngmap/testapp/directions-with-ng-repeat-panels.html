...
<body ng-app="ngMap">
	...
	<div ng-repeat="dir in directions">
		<div style="width: 68%; float: left; height: 450px">
			<ng-map style="height:100%"> <directions draggable="false"
				travel-mode="DRIVING" panel="{{dir.panelName}}"
				origin="{{dir.origin}}" destination="{{dir.destination}}">
			</directions> </ng-map>
		</div>
		<div id="{{dir.panelName}}"
			style="width: 32%; float: left; height: 450px"></div>
	</div>
