...
<head>
<meta charset="utf-8">
<title>Google Maps V3 API Events for google.maps.Map Demo</title>
<style type="text/css">
body {
	color: #585858;
...
<body>
	<div id="main">
		<p>
			...
			<code> google.maps.Map </code>
			object and shows when that happens, by highlighting the names to the
			right.
		</p>
		</p>
		Play around with the map and see what happens. For more information
		check <a
			href="https://code.google.com/apis/maps/documentation/javascript/reference.html#Map">the
			API reference</a>.
		</p>
		<div id="map">
			<h2>Map</h2>
