...
#panel {
	...
	<div ng-controller="OverlayHideshowCtrl as vm">
		<div id="panel">
			<input ng-click="vm.toggleVisibility()" type=button
				value="Toggle Visibility"> <input
				ng-click="vm.toggleDOMAttachment()" type=button
				value="Toggle DOM Attachment">
		</div>
		<ng-map zoom="11" center="62.323907, -150.109291"
			map-type-id="SATELLITE"> </ng-map>
	</div>
