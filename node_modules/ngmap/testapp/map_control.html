...
<body>
	All controls are messed up intentionally.
	<br />
	<br />
	<ng-map zoom="11" center="[40.74, -74.18]" zoom-control="true"
		...
		overview-map-control-options="{opened:true}" pan-control="true"
		...
		street-view-control-options='{position:"right_center"}'></ng-map>
