...
#panel {
	...
	<div ng-controller="MarkerRemoveCtrl as vm">
		Remove Markers<br /> Click on map to add a marker. Click button to
		show, hide, or remove markers<br />
		<div id="panel">
			<input ng-click="vm.hideMarkers()" type=button value="Hide Markers">
			<input ng-click="vm.showMarkers()" type=button
				value="Show All Markers"> <input
				ng-click="vm.deleteMarkers()" type=button value="Delete Markers">
		</div>
		<ng-map center="37.7699298, -122.4469157" zoom="12"
			on-click="vm.addMarker()"> <marker
