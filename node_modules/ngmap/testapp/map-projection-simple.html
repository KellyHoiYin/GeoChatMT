...
<body ng-controller="MapProjectionSimpleCtrl as vm">
	<ng-map zoom="0" center="0,0" on-click="alertLocation()"
		street-view-control="false" map-type-id="gallPetersMap"
		map-type-control-options="{
      mapTypeIds: ['ROADMAP', 'gallPetersMap']
    }">
	<map-type name="gallPetersMap" object="vm.mapTypeObject"> </map-type> </ng-map>
</body>
</html>
