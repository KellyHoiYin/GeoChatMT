...
<body ng-controller="EventPropertiesController as vm">
	...
	<br /> When zoom level changed, the contents of infoWindow also
	updates.
	<ng-map zoom="4" center="-25.363882, 131.044922" default-style="true"
		on-zoom_changed="vm.zoomChanged()"> <info-window id="1"
		position="-25.363882, 131.044922" visible="true">
