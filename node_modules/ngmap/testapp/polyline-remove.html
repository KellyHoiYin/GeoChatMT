...
<body ng-controller="PolylineRemoveCtrl as vm">
	...
	<ng-map zoom="3" center="0, -180" map-type-id="TERRAIN"> <shape
		name="polyline" id="foo"
		path="[
		...
		geodesic="true" stroke-color="#FF0000" stroke-opacity="1.0"
		stroke-weight="2"> </shape> </ng-map>
