...
<body>
	Circle Simple
	<br /> This example creates circles on the map, representing
	populations in North America.
	<div ng-controller="LayerDynamicMapsEngineCtrl as vm">
		<ng-map center="59.322506, 18.010025" zoom="14"> <dynamic-maps-engine-layer
			suppress-info-windows="true" clickable="true"
			on-mouseover="vm.onMouseover()" on-mouseout="vm.onMouseout()"
			layer-id="06673056454046135537-08896501997766553811">
		</dynamic-maps-engine-layer> </ng-map>
	</div>
</body>
</html>
